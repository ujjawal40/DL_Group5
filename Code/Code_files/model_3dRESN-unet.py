...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs, save_directory, patience=5,
    ...
    for epoch in range(num_epochs):
        ...
        if val_dice > best_val_dice:
            ...
            torch.save(model.state_dict(), os.path.join(save_directory, 'best_model_residualUnet3d.pth'))
        ...
        torch.save(model.state_dict(), os.path.join(save_directory, f'residualUnet3d_model_epoch_{epoch + 1}.pth'))
...
history = train_model(model, data_loader, val_loader, criterion, optimizer, 20, sav_model_dir, 5, 5)


history_df=pd.DataFrame(history)

history_df.to_csv('residualUnet3D_metrics.csv', index=False)
